...
@router.post("", response_model=JSendResponse[CategoryInDB])
async def create_category_endpoint(
    ...
    Args:
        category_data: The category data to create (including storeId)
    ...
    try:
        ...
        # Extract storeId from the category data
        ...
        return JSendResponse.success(created_category)
    except HTTPException as e:
        return JSendResponse.error(
            message=str(e.detail),
            code=e.status_code
